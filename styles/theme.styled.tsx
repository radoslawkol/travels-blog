...
export const darkTheme: any = {
	colors: {
		...
		darkPrimary: "#F8F8F8",
		darkSecondary: "#161C24",
		transparentDefault: " rgba(24, 23, 23, 0.719)",
		boxShadowDefault: "2px 4px 10px 6px rgba(22, 20, 20, 0.356);",
		boxShadowHover: "2px 4px 18px 10px rgba(0, 0, 0, 0.425)",
	},
	gradients: {
		primary:
			"linear-gradient(180deg, #C6B2A3 0%, rgba(237, 229, 222, 0.91) 100%)",
